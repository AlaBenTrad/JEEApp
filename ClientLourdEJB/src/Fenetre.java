...
public class Fenetre extends JFrame{
	...
	JLabel ab = new JLabel ("Gestion des livre ");
	JLabel code  = new JLabel ("Code_livre ");
	JLabel titre  = new JLabel ("Titre_livre ");
	JLabel mon_auteur  = new JLabel ("nom_livre ");
	...
	JRadioButton ctous= new JRadioButton ("Consulter Livre");
	JRadioButton ccode= new JRadioButton ("Consulter Livre par code ");
	...
	Fenetre.add(Tbd);
		...
		ab.setBounds(new Rectangle(200, 0, 200, 50));
		code.setForeground(Color.black);
		code.setFont(new java.awt.Font("Algerien",3,18));
		code.setBounds(new Rectangle(100, 80, 100, 20));
		...
		ccode.setBounds(new Rectangle(700, 180, 196, 25));
